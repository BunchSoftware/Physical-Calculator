...
QString fisic::FromFloatToString(float value){
    return QString::number(value);
}
void fisic::CheckLineEditIsEmpty(QString text, QString text2, QString text3, QString text4, QString text5){
